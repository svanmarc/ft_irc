...
Server::Server(int port) : m_serverSocket(-1), m_port(port), m_clients(), m_channels() {
...
bool Server::checkIfChannelExists(const std::vector<Channel> channels, const std::string &name) {
